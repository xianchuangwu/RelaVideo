...
import video.com.relavideodemo.MusicListBean;
...
//    });
    ...
    public void RtmpPreviewActivity(View view) {
        startActivity(new Intent(this, RtmpPreviewActivity.class));
    }

    public void AgoraPushActivity(View view) {
        startActivity(new Intent(this, AgoraVideoActivity.class));
    }

    public void FaceDetectorActivity(View view) {
        RxPermissions rxPermissions = new RxPermissions(this);
        rxPermissions.request(Manifest.permission.CAMERA
                , Manifest.permission.RECORD_AUDIO
                , Manifest.permission.READ_EXTERNAL_STORAGE
